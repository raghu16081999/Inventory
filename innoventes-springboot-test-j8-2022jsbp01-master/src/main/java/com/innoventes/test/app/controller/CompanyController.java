...
public class CompanyController {
	...
	public ResponseEntity<CompanyDTO> getByCompanyCode(@PathVariable(value = "companyCode") String companyCode)
	{
		return ResponseEntity.ok(companyService.getByCompanyCode(companyCode));
	}
	
	@PatchMapping("/company/{id}")
	public ResponseEntity<CompanyDTO> updatePartial(@PathVariable Long id,@RequestBody @Valid CompanyDTO dto) throws ValidationException
	{
		CompanyDTO update=companyService.updatePartial(id, dto);
